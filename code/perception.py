...
def is_valid_mapping(Rover):
    pitch_valid = Rover.pitch < 1 or Rover.pitch > 359
    roll_valid = Rover.roll < 1 or Rover.roll > 359
    return pitch_valid and roll_valid
...
def perception_step(Rover):
    ...
    # Apply color threshold to identify navigable terrain/obstacles/rocks
    ...
    if rock_map.any():
        ...
        if is_valid_mapping(Rover):
            Rover.worldmap[rock_y_cen, rock_x_cen, 1] = 255
